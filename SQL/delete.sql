-- Create a table called animals that has 4 columns: id - serialized integer that’s the primary key, name - can be any data type that 
-- holds strings, type - also for strings, and age which will be a whole number.
